...
class Indicators():
    ...
    def set_indicator_signals(self, indicator: str, buy: float, sell: float,
                              condition_buy: Any, condition_sell: Any) -> None:
    ...
    def change_in_price(self) -> pd.DataFrame:
        ...
        column_names = 'change_in_price'
        self._current_indicators[column_names] = {}
        self._current_indicators[column_names]['args'] = locals_data
        self._current_indicators[column_names]['func'] = self.change_in_price
        self._frame[column_names] = self._price_groups['close'].transform(
            lambda x: x.diff()
        )
    ...
    def rsi(self, period: int, method: str = 'wilders') -> pd.DataFrame:
        ...
        self._current_indicators[column_names] = {}
        self._current_indicators[column_names]['args'] = locals_data
        self._current_indicators[column_names]['func'] = self.rsi
        ...
        self._frame['rsi'] = np.where(relative_strength_index == 0,
                                      100, 100.0 - (100.0 / (1.0 + relative_strength)))
    ...
    def sma(self, period: int) -> pd.DataFrame:
        ...
        self._current_indicators[column_names] = {}
        self._current_indicators[column_names]['args'] = locals_data
        self._current_indicators[column_names]['func'] = self.sma
    ...
    def ema(self, period: int, alpha: float = 0.0) -> pd.DataFrame:
        ...
        self._current_indicators[column_names] = {}
        self._current_indicators[column_names]['args'] = locals_data
        self._current_indicators[column_names]['func'] = self.ema
